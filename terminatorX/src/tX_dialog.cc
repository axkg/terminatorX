...
void show_about(int nag)
{
	...
	if (nag) {
		...
		label=gtk_label_new("Copyright (C) 1999-2006 by Alexander K\xC3\xB6nig");
		gtk_box_pack_start(GTK_BOX(box2), label, WID_DYN);
		...
		label=gtk_label_new("This is "PACKAGE" release "VERSION" - Copyright (C) 1999-2006 by Alexander K\xC3\xB6nig"
